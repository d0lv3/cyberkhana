  ...
  return (
    <div className="max-w-2xl">
      <div className="flex items-center gap-3 mb-6">
        <div className="w-11 h-11 rounded-xl bg-brand/12 border border-brand/25 flex items-center justify-center">
          <Building2 className="w-5 h-5 text-brand" />
        </div>
        <div>
          <h1 className="text-2xl font-black text-fg">Your University</h1>
          <p className="text-sm text-muted">Edit the details students see for your institution.</p>
        </div>
      </div>

      <form onSubmit={handleSave} className="space-y-5 rounded-2xl border border-edge bg-panel p-6">
        {/* Code — immutable */}
        <div>
        ...
        <div>
          ...
          />
          <p className="mt-1.5 text-[11px] text-faint text-right">{form.description.length}/1000</p>
        </div>
        ...
        {success && (
          <div className="flex items-center gap-2 rounded-lg border border-brand/30 bg-brand/10 px-3 py-2.5 text-sm text-brand-neon">
        ...
        <button
          type="submit"
          disabled={saving}
          className="inline-flex items-center gap-2 rounded-lg bg-brand px-5 py-2.5 text-sm font-bold text-[#04150c] hover:bg-[#00c267] disabled:opacity-60 disabled:cursor-not-allowed transition-colors"
        >
