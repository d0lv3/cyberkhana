...
const Button: React.FC<ButtonProps> = ({ variant = 'primary', children, className, ...props }) => {
  ...
  const variantClasses = {
    primary: 'bg-brand-deep text-white hover:bg-brand-press focus:ring-brand disabled:bg-[#005a32] disabled:text-muted disabled:cursor-not-allowed shadow-lg hover:shadow-brand/20',
